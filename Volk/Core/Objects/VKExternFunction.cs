...
{
    public VKExternFunction(VKScope parentScope, string name, VKType returnType, bool isStatic, params VKObject[] parameters) : base(parentScope, name, returnType, isStatic, parameters)
    {
    }
